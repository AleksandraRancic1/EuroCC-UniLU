...
print(f"inference time on gpu is: {end_time -start_time:.2f} seconds")
...
imshow_save(torchvision.utils.make_grid(images[:16]), "/home/users/arancic/EuroCC/inference_outputs/predictions_batch2.png", predicted[:16], labels[:16], testset.classes)
print("Saved predictions to inference_outputs/predictions_batch2.png")